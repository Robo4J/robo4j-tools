 ...
 */
package com.robo4j.tools.magviz.math;

import com.robo4j.tools.magviz.ellipsoid.SolverException;
...
public class Tuple3d {
	...
	public void setEntry(int pos, double val){
		switch (pos){
			case 0:
				x = val;
				break;
			...
			case 2:
				...
				break;
			default:
				throw new SolverException("not supported dimension");
		}
	}
